...
def train_model(data_dir, num_epochs=Config.NUM_EPOCHS, batch_size=Config.BATCH_SIZE, learning_rate=Config.LEARNING_RATE):
    ...
    # ✅ 5. Replace final FC layer (for N classes)
    num_classes = Config.CLASSES_SIZE
...
if __name__ == '__main__':
    ...
    print(f"Training started for {Config.RESNET18_TRAIN_MODEL_PATH}(num_epochs={Config.NUM_EPOCHS},batch_size={Config.BATCH_SIZE},learning_rate={Config.LEARNING_RATE})")
